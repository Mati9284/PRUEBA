...
int main() // Funcion principal
{
	...
	if(edad < 12) // Si la edad es menor a 12
	{
		if(dia == 2 or dia == 4) // Y si el dia es martes(2) o jueves(4)
		{
			...
			cout << "El descuento que se aplica por la edad es de: " << "15%" << endl; // Precio del descuento de la edad expresado en pantalla
			cout << "El descuento que se aplica por el dia es de: " << "5%" << endl; // Precio del descuento del dia expresado en pantalla
		...
		else // Si el dia no es martes o jueves
		{
			...
			precio_con_descuento = precio - descuento1; // Calculo del precio con descuento
			cout << "El precio del producto es de: " << precio << " pesos" << endl; // Precio del producto base expresado en pantalla
			cout << "El descuento que se aplica por la edad es de: " << "15%" << endl; // Descuento de la edad expresado en pantalla // Precio del descuento expresado en pantalla
			cout << "El precio final del producto es de: " << precio_con_descuento << " pesos" << endl; // Precio final del producto expresado en pantalla
		}
	}
	else
	if(edad >= 60) // Si la edad es mayor o igual a 60
	{
		if(dia == 2 or dia == 4) // Y si el dia es martes o jueves
		{
			...
			precio_con_descuento = precio - descuento1; // Calculo del precio con descuento
			cout << "El precio del producto es de: " << precio << " pesos" << endl; // Precio del producto base expresado en pantalla
			cout << "El descuento que se aplica por la edad es de: " << "10%" << endl; // Precio del descuento de la edad expresado en pantalla
			cout << "El descuento por el dia es del: " << "5%" << endl; // Precio del descuento por el dia                         
			cout << "El precio final del producto es de: " << precio_con_descuento << " pesos" << endl; // Precio final del producto expresado en pantalla
		}
		else // Si el dia no es martes o jueves
		{
			...
			precio_con_descuento = precio - descuento1; // Calculo del precio con descuento
			cout << "El precio del producto es de: " << precio << " pesos" << endl; // Precio del producto base expresado en pantalla
			cout << "El descuento que se aplica por la edad es de: " << "10%" << endl; // Descuento de la edad expresado en pantalla
			cout << "El precio final del producto es de: " << precio_con_descuento << " pesos"<< endl; // Precio final del producto expresado en pantalla
		}
	}
	else
	if(edad >= 12 and edad < 60) // Si la edad es mayor o igual a 12 y la edad es menor a 60
	{
		if(dia == 2 or dia == 4) // Y el dia es martes o jueves
		{
			...
			precio_con_descuento = precio - descuento1; // Calculo del precio con descuento
			cout << "El precio del producto es de: " << precio << " pesos" << endl; // Precio del producto base expresado en pantalla
			cout << "El descuento que se aplica por el dia es de: " << "5%" << endl; // El descuento por el dia expresado en pantalla
			cout << "El precio final del producto es de: " << precio_con_descuento << " pesos" << endl; // Precio final del producto expresado en pantalla
		}
		else // Si el dia no es ni martes o jueves
		{
			cout << "El precio del producto es de: " << precio << " pesos" << endl; // Precio del producto base expresado en pantalla
			cout << "No se aplica ningun descuento" << endl; // Descuento expresado en pantalla
